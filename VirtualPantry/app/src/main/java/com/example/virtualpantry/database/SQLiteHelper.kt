...
class SQLiteHelper(context:Context?) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION){
    companion object{
        ...
        private const val DATE_END_AFTER_OPEN = "date_end_after_open"
    ...
    fun insertProduct(std:PantryItem): Long{
        ...
        contentValues.put(DATE_END_AFTER_OPEN, std.dateEndAfterOpen)
    ...
    fun getALLProducts(): ArrayList<PantryItem>{
        ...
        var unit: String
        var date_end: String
        var date_end_after_open: String
        ...
        if(cursor.moveToFirst())
        {
            do{
                ...
                date_end_after_open = cursor.getString(cursor.getColumnIndex(DATE_END_AFTER_OPEN))
                ...
                dateEndAfterOpen = date_end_after_open, dateOfAdd = date_of_add, productOpen = product_open,
